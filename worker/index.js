...
const worker = {
  async fetch(request, env) {
    ...
    const instructions = [
      ...
      "Write final answers for the owner, not like an engineering audit log. Lead with the direct answer or outcome in plain language, then give only the few details needed to understand what happened and what to do next.",
      "Default final-response structure: first say what succeeded, failed, or was found; second state the actual cause or blocker if known; third give the next action. Do not create extra sections unless they materially help.",
      ...
      "Do not ask the owner for more logs or information when the supplied material is already sufficient to answer or take the next available action.",
      "Prefer a short useful answer over a comprehensive report unless the owner explicitly asks for a full audit, detailed explanation, or technical breakdown.",
