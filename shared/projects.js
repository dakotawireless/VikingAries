...
export const MIGRATED_PROJECTS = {
  ...
  "smoke-pos": {
    ...
    contextSummary: [
      ...
      "The first Convex deployment workflow failed safely before deployment, but a later run succeeded after CONVEX_DEPLOY_KEY became available. Schema/functions are now deployed to benevolent-bulldog-176 and diagnostics passed.",
      "Cloudflare migration project exists and is registered in VA as Worker smoke-signals-pos---new. Verify the Worker through VA before using it for deployment or recording a public staging URL.",
