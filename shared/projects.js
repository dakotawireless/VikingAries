...
export const MIGRATED_PROJECTS = {
  ...
  "smoke-pos": {
    ...
    contextSummary: [
      ...
      "The first Convex deployment workflow failed safely because GitHub Actions secret CONVEX_DEPLOY_KEY is not configured. No schema/functions or data were changed in either Convex deployment.",
      "Cloudflare migration project exists and is expected to use Worker smoke-signals-pos---new. Verify the Worker through VA before using it for deployment or recording a public staging URL.",
